...
public class ModificaDipendenteTask_SostituisciDipendenteSalva  extends AbstractAction{

	private static final long serialVersionUID = 1L;
	private ModificaDipendentiTaskSostituisciDipendente mdtad;
	
	public ModificaDipendenteTask_SostituisciDipendenteSalva( ModificaDipendentiTaskSostituisciDipendente modta ){
		super("Salva");
		this.mdtad=modta;
	}
	@Override

ALTER TABLE EAzienda DROP FOREIGN KEY FKEAzienda759029;
...
CREATE TABLE EAzienda (NomeAzienda varchar(255) NOT NULL, EDirezioneID int(11) NOT NULL, EAziendaNomeAzienda varchar(255) NOT NULL, Indirizzo varchar(255), PRIMARY KEY (NomeAzienda));
CREATE TABLE EDipendente (CodiceFiscale varchar(255) NOT NULL, EDirezioneID int(11) NOT NULL, ETariffaID int(11) NOT NULL, IdDipendente int(11) NOT NULL, NomeDipendente varchar(255), CognomeDipendente varchar(255), Tipo varchar(255), Discriminator varchar(255) NOT NULL, PRIMARY KEY (CodiceFiscale));
...
ALTER TABLE EAzienda ADD INDEX FKEAzienda759029 (EAziendaNomeAzienda), ADD CONSTRAINT FKEAzienda759029 FOREIGN KEY (EAziendaNomeAzienda) REFERENCES EAzienda (NomeAzienda);

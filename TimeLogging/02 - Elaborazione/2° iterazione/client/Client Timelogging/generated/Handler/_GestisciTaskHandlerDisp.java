...
public abstract class _GestisciTaskHandlerDisp extends Ice.ObjectImpl implements GestisciTaskHandler
{
    ...
    public final void aggiungiDipendente(String aNomeProgetto, String aNomeSottoprogetto, String nomeTask, int IdDipendente)
    {
        aggiungiDipendente(aNomeProgetto, aNomeSottoprogetto, nomeTask, IdDipendente, null);
    }
    ...
    public final void sostituisciDipendente(String aNomeProgetto, String aNomeSottoprogetto, String nomeTask, int IdDipendente, int IdDipendenteOld)
    {
        sostituisciDipendente(aNomeProgetto, aNomeSottoprogetto, nomeTask, IdDipendente, IdDipendenteOld, null);
    }
    ...
    public static Ice.DispatchStatus ___aggiungiDipendente(GestisciTaskHandler __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        ...
        IdDipendente = __is.readInt();
        __inS.endReadParams();
        __obj.aggiungiDipendente(aNomeProgetto, aNomeSottoprogetto, nomeTask, IdDipendente, __current);
        __inS.__writeEmptyParams();
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    public static Ice.DispatchStatus ___sostituisciDipendente(GestisciTaskHandler __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        ...
        __inS.endReadParams();
        __obj.sostituisciDipendente(aNomeProgetto, aNomeSottoprogetto, nomeTask, IdDipendente, IdDipendenteOld, __current);
        __inS.__writeEmptyParams();
        return Ice.DispatchStatus.DispatchOK;
    }

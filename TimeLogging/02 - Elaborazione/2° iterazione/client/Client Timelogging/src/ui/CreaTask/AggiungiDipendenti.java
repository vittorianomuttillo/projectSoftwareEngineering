...
public class AggiungiDipendenti extends JDialog implements ActionListener {
    ...
    public AggiungiDipendenti(JFrame f, String nome, String desc){
    	super();
    	ff = f;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (SALVA.equals(cmd)) {
			...
			prx.creaTask(CreaTask.getProgetto(), CreaTask.getSottoprogetto(), this.descTask, 

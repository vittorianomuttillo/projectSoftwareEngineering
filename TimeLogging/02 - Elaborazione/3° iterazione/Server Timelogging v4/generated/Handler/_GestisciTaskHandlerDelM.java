...
public final class _GestisciTaskHandlerDelM extends Ice._ObjectDelM implements _GestisciTaskHandlerDel
{
    ...
    public void
    aggiungiDipendente(String aNomeProgetto, String aNomeSottoprogetto, String nomeTask, int IdDipendente, String unita, double quantita, java.util.Map<String, String> __ctx, Ice.Instrumentation.InvocationObserver __observer)
        throws IceInternal.LocalExceptionWrapper
    {
    ...
    public void
    sostituisciDipendente(String aNomeProgetto, String aNomeSottoprogetto, String nomeTask, int IdDipendente, String unita, double quantita, int IdDipendenteOld, java.util.Map<String, String> __ctx, Ice.Instrumentation.InvocationObserver __observer)
        throws IceInternal.LocalExceptionWrapper
    {

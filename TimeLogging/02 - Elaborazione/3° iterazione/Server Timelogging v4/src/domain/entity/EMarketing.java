...
public class EMarketing implements Serializable {
	...
	private ECalcoloStipendio calcoloStipendio;
	...
	public void calcolaStipendio(java.util.Set elenco_dipendenti) {
	    ...
	    while(iterator.hasNext()) {
	    	...
	    	stipendio = factory.factoryMethod(d.getTipo()).calcolaStipendio(d, timeInizio, timeFine);
	...
	public double calcolaStipendio(domain.entity.EDipendente dipendente) {
		...
		ECalcolaStipendioFactory factory = new ECalcolaStipendioFactory();
		System.out.println("asd"+factory+"dip"+dipendente.getTipo());
    	stipendio = factory.factoryMethod(dipendente.getTipo()).calcolaStipendio(dipendente, timeInizio, timeFine);

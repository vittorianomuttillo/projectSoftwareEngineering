...
public class EProgetto implements Serializable {
	...
	private java.util.Set elenco_sotoprogetti = new java.util.HashSet();
	...
	public void setElenco_sotoprogetti(java.util.Set value) {
		this.elenco_sotoprogetti = value;
	}
	
	public java.util.Set getElenco_sotoprogetti() {
		return elenco_sotoprogetti;
	}
	...
	public domain.entity.ESottoprogetto selezionaSottoprogetto(String nomeSottoprogetto) {
		Iterator<ESottoprogetto> iterator = this.elenco_sotoprogetti.iterator();

...
public class ESottoprogettoDAO {
	...
	public static boolean save(domain.entity.ESottoprogetto eSottoprogetto) {
		try {
			persistence.DAO.TimelogginPersistentManager.instance().saveObject(eSottoprogetto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(domain.entity.ESottoprogetto eSottoprogetto) {
		try {
			persistence.DAO.TimelogginPersistentManager.instance().deleteObject(eSottoprogetto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(domain.entity.ESottoprogetto eSottoprogetto) {
		try {
			persistence.DAO.TimelogginPersistentManager.instance().getSession().refresh(eSottoprogetto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(domain.entity.ESottoprogetto eSottoprogetto) {
		try {
			persistence.DAO.TimelogginPersistentManager.instance().getSession().evict(eSottoprogetto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();

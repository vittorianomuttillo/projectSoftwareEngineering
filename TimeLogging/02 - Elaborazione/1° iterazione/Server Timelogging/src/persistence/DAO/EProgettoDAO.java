...
public class EProgettoDAO {
	...
	public static boolean save(domain.entity.EProgetto eProgetto) {
		try {
			persistence.DAO.TimelogginPersistentManager.instance().saveObject(eProgetto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(domain.entity.EProgetto eProgetto) {
		try {
			persistence.DAO.TimelogginPersistentManager.instance().deleteObject(eProgetto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(domain.entity.EProgetto eProgetto) {
		try {
			persistence.DAO.TimelogginPersistentManager.instance().getSession().refresh(eProgetto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(domain.entity.EProgetto eProgetto) {
		try {
			persistence.DAO.TimelogginPersistentManager.instance().getSession().evict(eProgetto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();

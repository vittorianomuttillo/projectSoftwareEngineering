...
public class EAziendaDAO {
	...
	public static boolean save(domain.entity.EAzienda eAzienda) {
		try {
			persistence.DAO.TimelogginPersistentManager.instance().saveObject(eAzienda);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(domain.entity.EAzienda eAzienda) {
		try {
			persistence.DAO.TimelogginPersistentManager.instance().deleteObject(eAzienda);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(domain.entity.EAzienda eAzienda) {
		try {
			persistence.DAO.TimelogginPersistentManager.instance().getSession().refresh(eAzienda);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(domain.entity.EAzienda eAzienda) {
		try {
			persistence.DAO.TimelogginPersistentManager.instance().getSession().evict(eAzienda);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();

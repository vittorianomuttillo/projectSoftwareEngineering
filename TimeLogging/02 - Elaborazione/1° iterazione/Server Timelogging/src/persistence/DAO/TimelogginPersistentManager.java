...
public class TimelogginPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Timeloggin";
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new TimelogginPersistentManager();
		}
